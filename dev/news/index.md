...
- Removed a duplicate internal
  [`file_name()`](https://reginalexavier.github.io/wcswatin/dev/reference/file_name.md)
  implementation.
...
Initial release of wcswatin (Weather & Climate SWAT INput) package for
preparing weather and climate data for input in the Soil & Water
...
- Comprehensive test suite with cross-platform support (Windows, macOS,
  Linux)
- CI/CD with GitHub Actions (R-CMD-check, test-coverage, pkgdown)
- Documentation website available at

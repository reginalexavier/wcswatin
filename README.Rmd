...
cwswatinput (Climate & Weater SWAT input) is an open-source R package for pre-processing weather and climate data input in the Soil & Water Assessment Tool (SWAT) and exploratory analysis.

...
cwswatinput (Climate & Weater SWAT input) is an open-source R package for pre-processing weather and climate data input in the Soil & Water Assessment Tool (SWAT) and exploratory analysis. O package possui a sua funcionalidade validada para a grade de dados meteorológicos ERA5_Land [Climate Change Service](https://cds.climate.copernicus.eu/cdsapp#!/dataset/reanalysis-era5-land?tab=overview) e para as grades de precipitação GPM [GES DISC](https://disc.gsfc.nasa.gov/datasets/GPM_3IMERGDF_06/summary?keywords="IMERG%20final") e PERSIANN [PERSIANN-CCS](https://chrsdata.eng.uci.edu/).

...
#' @exportMethod daily_aggregation
#'

methods::setGeneric(name = "daily_aggregation",
                    def = function(folder_in,
                                   folder_out,
                                   pattern = ".txt$",
                                   from = '2002-01-01 00',
                                   to = '2021-05-31 23',
                                   ...
                                   na.rm = FALSE) {
                      standardGeneric("daily_aggregation")
                    }
)


# S4 method for signature 'latest'
#' @rdname daily_aggregation
#' @aliases daily_aggregation-latest
methods::setMethod("daily_aggregation", methods::signature(aggregation_function = "latest"),
                   function(folder_in,
                            folder_out,
                            pattern = ".txt$",
                            from = '2002-01-01 00',
...
# S4 method for signature 'min_max'
#' @rdname daily_aggregation
#' @aliases daily_aggregation-min_max
methods::setMethod("daily_aggregation", methods::signature(aggregation_function = "min_max"),
                   function(folder_in,
                            folder_out,
                            pattern = ".txt$",
                            from = '2002-01-01 00',
